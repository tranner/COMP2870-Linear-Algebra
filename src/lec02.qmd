...
as floating point numbers last year in the module COMP1860 Building our Digital
World.
...
```
However, in some extreme edge cases you are unlikely in meet, Python floats do
not follow IEE double-precision standard on some extreme edge cases.

Here is an example of how we can work with these abstracted systems:
