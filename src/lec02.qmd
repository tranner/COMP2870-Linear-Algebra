...
the material yourself in Lab Session 1 (@sec-lab1).
...
bits (binary digits), typically 32 or 64 of them. You learned how to store
...
```
However, in some extreme edge cases, you are unlikely to meet, Python floats do
not follow the IEEE double-precision standard in some extreme edge cases.
...
# find smallest difference between numbers
min_diff = 99
