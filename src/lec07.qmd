...
Since $A$ is diagonal, we can read off the eigenvalues are $1$ and $2$ and we can take $(1, 0)^T$ and $(0, 1)^T$ are eigevectors:
$$
...
$$
0 = \det (B - \lambda I_2)
\det \begin{pmatrix} 1 - \lambda & - 2 \\ 0 & 2 \end{pmatrix} = (1 - \lambda)(2 - \lambda).
$$
