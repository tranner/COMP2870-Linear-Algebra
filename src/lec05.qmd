...
poly_sparse = np.poly1d([np.polyfit(ns, timing_sparse, 1)[0], 0])(np.array(ns, dtype=np.double))
poly_dense = np.poly1d([np.polyfit(ns, timing_dense, 2)[0], 0, 0])(np.array(ns, dtype=np.double))
