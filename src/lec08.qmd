...
P_2 P_3, \ldots
\end{equation}
If we get all the way to a diagonal matrix, at level $m$ say, then the
eigenvalues are the diagonal of the matrix
\begin{equation*}
...
- \frac{\sqrt{2 - \sqrt{2}}}{2} & - \frac{1}{2} - \frac{\sqrt{2}}{4} &
\frac{\sqrt{2}}{4}\\
