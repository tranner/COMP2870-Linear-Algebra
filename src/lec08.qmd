...
to get a QR factorisation is to use the Gram-Schmidt process. In general,
...
You will see in the lab session ways to improve our basic algorithm that allows
faster, more robust convergence.
